...
public class WareHouseScreenProtector implements Scraper {
    ...
    public String getScrapeURL() {
        return getBaseURL() + "/c/electronics-gaming/tech-accessories/phone-accessories/screen-protectors";
    }
...
//            String caseUrl = getBaseURL() + e.select(".link").attr("href");
            ...
            cases.add(new ScreenProtector(title, model, url,image, image, price,"WareHouse"));
